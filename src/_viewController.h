...
void _threeButtonMenu(char *leftButtonText, char *middleButtonText, char *rightButtonText);


void twoButtonMenu(char *leftButtonText, char *rightButtonText);

void _threeButtonText(char *leftButtonText, char *middleButtonText, char *rightButtonText);
